...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-48 md:w-96 h-48 md:h-96 bg-[oklch(0.78_0.11_65_/_0.12)] rounded-full blur-2xl md:blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-32 md:w-64 h-32 md:h-64 bg-[oklch(0.78_0.11_65_/_0.10)] rounded-full blur-2xl md:blur-3xl animate-pulse" />
      <div className="hidden md:block absolute top-1/2 right-1/3 w-48 h-48 bg-[oklch(0.85_0.09_60_/_0.08)] rounded-full blur-2xl" />
